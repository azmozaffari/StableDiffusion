...
I have used [DreamBooth](https://github.com/google/dreambooth) to train a StableDiffusion model with few number of samples of the item. Here my samples were Apple watch and DARA doll. Then the stable diffusion is capable to generate the brand item.
